...
public class Parser {
    private static final Pattern ADD_PATTERN = Pattern.compile("^(?<keyword>\\bdeadline\\b|\\bevent\\b|\\btodo\\b)\\s?(?<args>.*)$", Pattern.CASE_INSENSITIVE);
    ...
    public Command readInput(Scanner sc) throws InvalidCommandException, InvalidCommandFormatException {
