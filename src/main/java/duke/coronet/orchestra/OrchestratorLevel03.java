...
public class OrchestratorLevel03 extends AbstractOrchestrator {

    public static void main(String[] args) throws Exception {
        new OrchestratorLevel03(new TaskManager(), null, new UxManager(System.out)).run();
    }

    public OrchestratorLevel03(TaskManager tm, FileResourceManager frm, UxManager uxMgr) {
        super(tm, frm, uxMgr);
